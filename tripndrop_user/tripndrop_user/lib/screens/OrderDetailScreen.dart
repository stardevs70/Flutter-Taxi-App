...
import 'package:taxi_booking/model/OrderHistory.dart';
...
import 'package:taxi_booking/utils/Extensions/animatedList/animated_scroll_view.dart';
...
import 'package:taxi_booking/utils/Extensions/decorations.dart';
                            ...
                            Container(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  widget.orderData!.datetime != null
                                      ? Text('${DateFormat('dd MMM yyyy hh:mm a').format(DateTime.parse("${widget.orderData?.datetime!}").toLocal())} ',
                                            ...
                                            children: [
                                              Row(
                                                children: [
                                                  ...
                                                  4.width,
                                                  Text('${widget.orderData?.distance?.toStringAsFixed(2).toString() ?? ''}km', style: boldTextStyle(), overflow: TextOverflow.ellipsis, maxLines: 1),
                                                ],
                                              ),
                                              Row(
                                                children: [
