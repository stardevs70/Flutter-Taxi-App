...
import 'package:taxi_booking/service/AuthService1.dart';
              ...
              child: Column(
                ...
                children: [
                  AppTextField(
                    ...
                    decoration:
                        inputDecoration(context, label: language.oldPassword),
                  ...
                  AppTextField(
                    ...
                    decoration:
                        inputDecoration(context, label: language.newPassword),
                    errorThisFieldRequired: language.thisFieldRequired,
                    errorMinimumPasswordLength: language.passwordInvalid,
                  ),
                  SizedBox(height: 16),
