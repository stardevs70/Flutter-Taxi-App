...
class ServicesListData {
  ...
  factory ServicesListData.fromJson(Map<String, dynamic> json) {
    return ServicesListData(
      ...
      perDistanceCharge: json['per_distance_charge'].runtimeType !=num?int.parse(json['per_distance_charge'].toString()):json['per_distance_charge'],
      pickupDuration: json['pickup_duration'],
      fixed_charge: num.tryParse(json['fixed_charge'].toString()),
      region: json['region'] != null ? Region.fromJson(json['region']) : null,
      regionId: json['region_id'],
      serviceImage: json['service_image'],
      serviceMarker : json['service_marker'],
      status: json['status'],
      ...
      description: json['description'],
        perWeightCharge : json['per_weight_charge'],
  ...
  Map<String, dynamic> toJson() {
    ...
    data['service_marker'] = this.serviceMarker;
    ...
    data['minimum_weight'] = this.minimumWeight;
    ...
    data['per_weight_charge'] = this.perWeightCharge;
