...
class OnRideRequest {
  ...
  int? tripProtection;
  num? tripProtectionPrice;
  int? meetAndGreet;
  num? meetAndGreetPrice;
  String? meetGreetName;
  String? meetGreetComments;
  int? travelingWithPet;
  num? travelingWithPetPrice;
  int? childSeat;
  num? childSeatPrice;
  int? boosterSeatCount;
  int? rearFacingInfantSeatCount;
  int? forwardFacingToddlerSeatCount;
  num? extrasAmount;
  ...
  OnRideRequest({
    ...
    this.isRideForOther,
    this.tripProtection,
    this.tripProtectionPrice,
    this.meetAndGreet,
    this.meetAndGreetPrice,
    this.meetGreetName,
    this.meetGreetComments,
    this.travelingWithPet,
    this.travelingWithPetPrice,
    this.childSeat,
    this.childSeatPrice,
    this.boosterSeatCount,
    this.rearFacingInfantSeatCount,
    this.forwardFacingToddlerSeatCount,
    this.extrasAmount,
  });
  ...
  OnRideRequest.fromJson(Map<String, dynamic> json) {
    ...
    // Extra booking options
    tripProtection = json['trip_protection'];
    tripProtectionPrice = json['trip_protection_price'];
    meetAndGreet = json['meet_and_greet'];
    meetAndGreetPrice = json['meet_and_greet_price'];
    meetGreetName = json['meet_greet_name'];
    meetGreetComments = json['meet_greet_comments'];
    travelingWithPet = json['traveling_with_pet'];
    travelingWithPetPrice = json['traveling_with_pet_price'];
    childSeat = json['child_seat'];
    childSeatPrice = json['child_seat_price'];
    boosterSeatCount = json['booster_seat_count'];
    rearFacingInfantSeatCount = json['rear_facing_infant_seat_count'];
    forwardFacingToddlerSeatCount = json['forward_facing_toddler_seat_count'];
