...
class AppSettingModel {
    ...
    AppSettingModel({this.reference_type,this.maxEarningPerMonth,this.reference_amount,this.region, this.rideSetting, this.walletSetting, this.currencySetting, this.settingModel, this.privacyPolicyModel, this.termsCondition});

    AppSettingModel.fromJson(Map<String, dynamic> json) {
        reference_type = json['reference_type'];
        maxEarningPerMonth = json['maxEarningPerMonth'].toString();
        reference_amount = json['reference_amount'].toString();
