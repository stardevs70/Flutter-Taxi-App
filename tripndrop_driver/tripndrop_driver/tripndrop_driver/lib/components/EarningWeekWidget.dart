...
class EarningWeekWidgetState extends State<EarningWeekWidget> {
  ...
  void init() async {
    ...
    await earningList(req: req).then((value) {
      ...
      if (value.totalOnlineRide != null) totalOnlineRide = value.totalOnlineRide!;
            ...
            SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                    ...
                    child: SfCartesianChart(
                      ...
                      series: <CartesianSeries<WeekReport, String>>[
                        StackedColumnSeries<WeekReport, String>(
                          ...
                          xValueMapper: (WeekReport exp, _) => exp.day!.substring(0, 3),
                  ...
                  SizedBox(height: 16),
                  earningText(title: language.online, amount: totalOnlineRide),
                  SizedBox(height: 16),
