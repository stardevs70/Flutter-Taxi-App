            ...
            children: [
              ...
              Row(
                ...
                children: [
                  Text(
                    time,
                    style: primaryTextStyle(color: !widget.data!.isMe.validate() ? Colors.blueGrey.withValues(alpha: 0.6) : Colors.white.withValues(alpha: 0.6), size: 10),
                  ),
                  SizedBox(height: 2),
                  widget.data!.isMe!
                      ...
                      children: [
                        Text(
                          ...
                          style: primaryTextStyle(
                            color: !widget.data!.isMe.validate() ? Colors.blueGrey.withValues(alpha: 0.6) : Colors.white.withValues(alpha: 0.6),
                            size: 10,
                          ),
                        ),
                        SizedBox(height: 2),
      ...
      onLongPress: !widget.data!.isMe!
          ...
          : () async {
              ...
              if (res ?? false) {
                ...
                chatMessageService.deleteSingleMessage(senderId: widget.data!.senderId, receiverId: widget.data!.receiverId!, documentId: widget.data!.id).then((value) {}).catchError(
                  (e) {
                    log(e.toString());
                  },
                );
