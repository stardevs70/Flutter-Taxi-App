...
/// Hourly Booking Constants per Section 8 + Client Update
/// Client requested: half-hour (30-min) billing blocks instead of 10-minute
class HourlyBookingConstants {
  ...
  static const int defaultIncludedMilesPerHour = 30;

  /// Default extra mile fee ($5.50 per mile over limit)
  static const double defaultExtraMileFee = 5.50;

  /// Extension rounding block in minutes
  /// Client requirement: Half-hour (30-min) billing - even 5 mins over = half hour charge
  static const int extensionRoundingMinutes = 30;

  /// Calculate rounded extension minutes (to half-hour blocks)
  /// Per client: Any time over = half hour charge
