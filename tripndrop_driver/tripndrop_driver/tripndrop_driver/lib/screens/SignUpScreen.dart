      ...
      if (isAcceptedTc) {
        ...
        Map req = {
          ...
          "user_detail": {
            ...
            'car_make': carMakeController.text.trim(),
                    ...
                    content: Form(
                      ...
                      child: Column(
                        children: [
                          ...
                          SizedBox(height: 8),
                          AppTextField(textFieldType: TextFieldType.NAME, controller: carMakeController, decoration: inputDecoration(context, label: 'Vehicle Make')),
                          SizedBox(height: 8),
