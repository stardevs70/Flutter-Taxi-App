...
class ScreenkeywordSeeder extends Seeder
{
  ...
  public function run()
  {
    ...
    [
      [
        ...
        "keyword_data"=> [
          [
            ...
            "keyword_value"=> "Receive Service Request"
          ],
          [
            "screenId"=> "1",
            "keyword_id"=> 363,
            "keyword_name"=> "driver_walkthrough_title_2",
            "keyword_value"=> "Pickup from Location"
          ],
          [
            "screenId"=> "1",
            "keyword_id"=> 364,
            "keyword_name"=> "driver_walkthrough_title_3",
            "keyword_value"=> "Complete the Drop"
          ],
          [
            "screenId"=> "1",
            "keyword_id"=> 365,
            "keyword_name"=> "driver_walkthrough_subtitle_1",
            "keyword_value"=> "Get a service request from nearby users"
          ],
          [
            "screenId"=> "1",
            "keyword_id"=> 366,
            "keyword_name"=> "driver_walkthrough_subtitle_2",
            "keyword_value"=> "Confirm & Navigate to Pickup"
          ],
          [
            "screenId"=> "1",
            "keyword_id"=> 367,
            "keyword_name"=> "driver_walkthrough_subtitle_3",
            "keyword_value"=> "Safely drop off"
          ],
          [
            "screenId"=> "1",
            "keyword_id"=> 369,
          ...
          [
            ...
            "keyword_value"=> "Choose a Service"
          ],
          [
            "screenId"=> "1",
            "keyword_id"=> 271,
            "keyword_name"=> "walkthrough_title_2",
            "keyword_value"=> "Smooth & Secure Journey"
          ],
          [
            "screenId"=> "1",
            "keyword_id"=> 272,
            "keyword_name"=> "walkthrough_title_3",
            "keyword_value"=> "Track in Real Time"
          ],
          [
            "screenId"=> "1",
            "keyword_id"=> 273,
            "keyword_name"=> "walkthrough_subtitle_1",
            "keyword_value"=> "We move what matters — safely and on schedule"
          ],
          [
            "screenId"=> "1",
            "keyword_id"=> 274,
            "keyword_name"=> "walkthrough_subtitle_2",
            "keyword_value"=> "Smart, stress-free service"
          ],
          [
            "screenId"=> "1",
            "keyword_id"=> 275,
            "keyword_name"=> "walkthrough_subtitle_3",
            "keyword_value"=> "Track your service status live on the map"
          ],
          [
            "screenId"=> "1",
            "keyword_id"=> 129,
          ...
          [
            ...
            "keyword_value"=> "Confirm Service Completion"
          ]
        ]
      ],
      [
      ...
      [
        ...
        "keyword_data"=> [
          [
            "screenId"=> "5",
            "keyword_id"=> 491,
            "keyword_name"=> "lblCancellationFee",
            "keyword_value"=> "Cancellation Fee"
          ],
          [
            "screenId"=> "5",
            "keyword_id"=> 492,
            "keyword_name"=> "lblPerWeightCharge",
            "keyword_value"=> "Per Weight Charge"
          ],
          [
            "screenId" => "5",
            "keyword_id" => 493,
          ...
          [
            "screenId"=> "5",
            "keyword_id"=> 481,
            "keyword_name"=> "lblPassengers",
            "keyword_value"=> "Passengers"
          ],
          [
            "screenId"=> "5",
            "keyword_id"=> 482,
            "keyword_name"=> "lblLuggage",
            "keyword_value"=> "Luggage"
          ],
          [
            "screenId"=> "5",
            "keyword_id"=> 483,
            "keyword_name"=> "lblUpcomingService",
            "keyword_value"=> "Upcoming Service"
          ],
          [
            "screenId"=> "5",
            "keyword_id"=> 484,
            "keyword_name"=> "lblReferAndEarn",
            "keyword_value"=> "Refer & Earn"
          ],
          [
            "screenId"=> "5",
            "keyword_id"=> 485,
            "keyword_name"=> "lblEarnedReward",
            "keyword_value"=> "Earned Reward"
          ],
          [
            "screenId"=> "5",
            "keyword_id"=> 427,
            "keyword_name"=> "tripType",
            "keyword_value"=> "Trip Type"
          ],
          [
            "screenId"=> "5",
            "keyword_id"=> 428,
            "keyword_name"=> "flightNumber",
            "keyword_value"=> "Flight Number"
          ],
          [
            "screenId"=> "5",
            "keyword_id"=> 429,
            "keyword_name"=> "terminalAddress",
            "keyword_value"=> "Terminal"
          ],
          [
            "screenId"=> "5",
            "keyword_id"=> 430,
            "keyword_name"=> "preferredPickupTime",
            "keyword_value"=> "Person Pickup Time"
          ],
          [
            "screenId"=> "5",
            "keyword_id"=> 431,
            "keyword_name"=> "preferredDropTime",
            "keyword_value"=> "Preferred Drop-off Time"
          ],
          [
            "screenId"=> "5",
            "keyword_id"=> 432,
            "keyword_name"=> "terminalHelperText",
            "keyword_value"=> "(like Arrival Gate A, Terminal 3, etc.)"
          ],
          [
            "screenId"=> "5",
            "keyword_id"=> 433,
            "keyword_name"=> "bookService",
            "keyword_value"=> "Book Service"
          ],
          [
            "screenId"=> "5",
            "keyword_id"=> 434,
            "keyword_name"=> "estimate",
            "keyword_value"=> "Estimate"
          ],
          [
            "screenId"=> "5",
            "keyword_id"=> 435,
            "keyword_name"=> "bookedBy",
            "keyword_value"=> "Booked By"
          ],
          [
            "screenId"=> "5",
            "keyword_id"=> 436,
            "keyword_name"=> "flightDetails",
            "keyword_value"=> "Flight Details"
          ],
          [
            "screenId"=> "5",
            "keyword_id"=> 437,
          ...
          [
            "screenId"=> "5",
            "keyword_id"=> 438,
            "keyword_name"=> "bookTaxi",
            "keyword_value"=> "Book Taxi"
          ],
          [
            "screenId"=> "5",
            "keyword_id"=> 439,
            "keyword_name"=> "bookParcel",
            "keyword_value"=> "Book Parcel"
          ],
          [
            "screenId"=> "5",
            "keyword_id"=> 440,
            "keyword_name"=> "notResponse",
            "keyword_value"=> "User is not responding"
          ],
          [
            "screenId"=> "5",
            "keyword_id"=> 441,
            "keyword_name"=> "userRefused",
            "keyword_value"=> "User refused to hand over parcel"
          ],
          [
            "screenId"=> "5",
            "keyword_id"=> 442,
            "keyword_name"=> "breakdown",
            "keyword_value"=> "vehicle breakdown"
          ],
          [
            "screenId"=> "5",
            "keyword_id"=> 443,
            "keyword_name"=> "heavyTraffic",
            "keyword_value"=> "Heavy traffic or road closed"
          ],
          [
            "screenId"=> "5",
            "keyword_id"=> 444,
            "keyword_name"=> "recipientNot",
            "keyword_value"=> "Recipient asked not to deliver"
          ],
          [
            "screenId"=> "5",
            "keyword_id"=> 463,
            "keyword_name"=> "regular",
            "keyword_value"=> "Regular"
          ],
          [
            "screenId"=> "5",
            "keyword_id"=> 464,
            "keyword_name"=> "airPickup",
            "keyword_value"=> "Airport Pickup"
          ],
          [
            "screenId"=> "5",
            "keyword_id"=> 465,
            "keyword_name"=> "airDropOff",
            "keyword_value"=> "Airport Dropoff"
          ],
          [
            "screenId"=> "5",
            "keyword_id"=> 466,
            "keyword_name"=> "zoneWise",
            "keyword_value"=> "Zone Wise"
          ],
          [
            "screenId"=> "5",
            "keyword_id"=> 467,
            "keyword_name"=> "zoneToAir",
            "keyword_value"=> "Zone to Airport"
          ],
          [
            "screenId"=> "5",
            "keyword_id"=> 468,
            "keyword_name"=> "airToZone",
            "keyword_value"=> "Airport to Zone"
          ],
          [
            "screenId"=> "5",
            "keyword_id"=> 469,
            "keyword_name"=> "wrongAdd",
            "keyword_value"=> "Wrong address entered"
          ],
          [
            "screenId"=> "5",
            "keyword_id"=> 470,
            "keyword_name"=> "changeTime",
            "keyword_value"=> "I want to change delivery time"
          ],
          [
            "screenId"=> "5",
            "keyword_id"=> 471,
            "keyword_name"=> "ParcelNoLonger",
            "keyword_value"=> "Parcel no longer needs to be sent"
          ],
          [
            "screenId"=> "5",
            "keyword_id"=> 472,
            "keyword_name"=> "byMistake",
            "keyword_value"=> "Booking made by mistake"
          ],
          [
            "screenId"=> "5",
            "keyword_id"=> 473,
            "keyword_name"=> "enterWight",
            "keyword_value"=> "Enter Weight"
          ],
          [
            "screenId"=> "5",
            "keyword_id"=> 474,
            "keyword_name"=> "enterParcel",
            "keyword_value"=> "Enter parcel type"
          ],
          [
            "screenId"=> "5",
            "keyword_id"=> 475,
            "keyword_name"=> "enterSenderName",
            "keyword_value"=> "Enter sender's name"
          ],
          [
            "screenId"=> "5",
            "keyword_id"=> 476,
            "keyword_name"=> "enterSenderContact",
            "keyword_value"=> "Enter sender's contact"
          ],
          [
            "screenId"=> "5",
            "keyword_id"=> 477,
            "keyword_name"=> "enterReceiverName",
            "keyword_value"=> "Enter receiver's name"
          ],
          [
            "screenId"=> "5",
            "keyword_id"=> 478,
            "keyword_name"=> "enterReceiverContact",
            "keyword_value"=> "Enter receiver's contact"
          ],
          [
            "screenId"=> "5",
            "keyword_id"=> 479,
            "keyword_name"=> "timeOfPickup",
            "keyword_value"=> "Enter receiver's contact"
          ],
          [
            "screenId"=> "5",
          ...
          [
            "screenId"=> "5",
            "keyword_id"=> 416,
            "keyword_name"=> "collectAmount",
            "keyword_value"=> "Collect Amount"
          ],
          [
            "screenId"=> "5",
            "keyword_id"=> 417,
            "keyword_name"=> "collectOrder",
            "keyword_value"=> "Collect Order"
          ],
          [
            "screenId"=> "5",
            "keyword_id"=> 418,
            "keyword_name"=> "paymentReceive",
            "keyword_value"=> "Payment Received?"
          ],
          [
            "screenId"=> "5",
            "keyword_id"=> 419,
            "keyword_name"=> "paymentReceiveDesc",
            "keyword_value"=> "Have you collected the payment from the customer?"
          ],
          [
            "screenId"=> "5",
            "keyword_id"=> 420,
            "keyword_name"=> "completeDelivery",
            "keyword_value"=> "Complete Order"
          ],
          [
            "screenId"=> "5",
            "keyword_id"=> 390,
          ...
          [
            "screenId"=> "5",
            "keyword_id"=> 391,
            "keyword_name"=> "schedule_at",
            "keyword_value"=> "Schedule At"
          ],
          [
            "screenId"=> "5",
            "keyword_id"=> 392,
          ...
          [
            "screenId"=> "5",
            "keyword_id"=> 393,
            "keyword_name"=> "schedule_list_title",
            "keyword_value"=> "My Schedule"
          ],
          [
            "screenId"=> "5",
            "keyword_id"=> 394,
            "keyword_name"=> "schedule_list_desc",
            "keyword_value"=> "Manage your upcoming trips with ease. Your planned rides appear here."
          ],
          [
            "screenId"=> "5",
            "keyword_id"=> 383,
            "keyword_name"=> "tripDistance",
            "keyword_value"=> "Trip Distance"
          ],
          [
            "screenId"=> "5",
            "keyword_id"=> 92,
          ...
          [
            ...
            "keyword_value"=> "Set pickup and drop locations"
          ],
          [
            "screenId"=> "5",
            "keyword_id"=> 95,
          ...
          [
            ...
            "keyword_value"=> "Looking for nearby service providers"
          ],
          [
            "screenId"=> "5",
            "keyword_id"=> 105,
            "keyword_name"=> "weAreLookingForNearDriversAcceptsYourRide",
            "keyword_value"=> "We are looking for nearby service providers to accept your service"
          ],
          [
            "screenId"=> "5",
            "keyword_id"=> 167,
      ...
      [
        ...
        "keyword_data"=> [
          ...
          [
            ...
            "keyword_value"=> "CUSTOMER INFORMATION"
          ],
          [
            "screenId"=> "9",
            "keyword_id"=> 312,
            "keyword_name"=> "aboutRider",
            "keyword_value"=> "About Customer"
          ],
          [
            "screenId"=> "9",
            "keyword_id"=> 308,
      ...
      [
        ...
        "keyword_data"=> [
          [
            "screenId"=> "14",
            "keyword_id"=> 486,
            "keyword_name"=> "maxTransferIs",
            "keyword_value"=> "Max Transfer per Transaction is"
          ],
          [
            "screenId"=> "14",
            "keyword_id"=> 46,
      ...
      [
        ...
        "keyword_data"=> [
          ...
          [
            ...
            "keyword_value"=> "Choose you payment now or later"
          ],
          [
            "screenId"=> "25",
            "keyword_id"=> 56,
          ...
          [
            ...
            "keyword_value"=> "Confirm the Customer & make sure the trip information"
          ],
          [
            "screenId"=> "25",
            "keyword_id"=> 180,
          ...
          [
            "screenId"=> "25",
            "keyword_id"=> 253,
            "keyword_name"=> "ridecancelledByDriver",
            "keyword_value"=> "Ride cancelled by Driver"
          ],
          [
            "screenId"=> "25",
            "keyword_id"=> 264,
      ...
      [
        ...
        "keyword_data"=> [
          ...
          [
            "screenId"=> "26",
            "keyword_id"=> 381,
            "keyword_name"=> "fullCashPayment",
            "keyword_value"=> "Make Full Payment in Cash."
          ],
          [
            "screenId"=> "26",
            "keyword_id"=> 382,
            "keyword_name"=> "moreMoneyForWalletPayment",
            "keyword_value"=> "more needed for ride payment."
          ],
          [
            "screenId"=> "26",
            "keyword_id"=> 61,
          ...
          [
            ...
            "keyword_value"=> "Waiting for Payment to Complete"
          ],
          [
            "screenId"=> "26",
            "keyword_id"=> 78,
          ...
          [
            ...
            "keyword_value"=> "Complete Payment"
          ],
          [
            "screenId"=> "26",
            "keyword_id"=> 80,
      ...
      [
        ...
        "keyword_data"=> [
          [
            ...
            "keyword_value"=> "Customer Review"
          ],
          [
            "screenId"=> "27",
            "keyword_id"=> 82,
            "keyword_name"=> "howWasYourRide",
            "keyword_value"=> "How was your experience with us?"
          ],
          [
            "screenId"=> "27",
            "keyword_id"=> 83,
      ...
      [
        ...
        "keyword_data"=> [
          ...
          [
            ...
            "keyword_value"=> "Most Reliable TripNDrop App"
          ],
          [
            "screenId"=> "30",
            "keyword_id"=> 140,
      ...
      [
        ...
        "keyword_data"=> [
          [
            "screenId"=> "32",
            "keyword_id"=> 387,
            "keyword_name"=> "update_available",
            "keyword_value"=> "App Update Available"
          ],
          [
            "screenId"=> "32",
            "keyword_id"=> 388,
            "keyword_name"=> "update_desc",
            "keyword_value"=> "A new version is ready! Update now for the latest features and improvements."
          ],
          [
            "screenId"=> "32",
            "keyword_id"=> 389,
            "keyword_name"=> "update_now",
      ...
      [
        ...
        "keyword_data"=> [
          [
            "screenId"=> "34",
            "keyword_id"=> 384,
            "keyword_name"=> "platformFee",
            "keyword_value"=> "Platform Fee"
          ],
          [
            "screenId"=> "34",
            "keyword_id"=> 385,
            "keyword_name"=> "youWillGet",
            "keyword_value"=> "You Will Get"
          ],
          [
            "screenId"=> "34",
            "keyword_id"=> 386,
            "keyword_name"=> "enterValidAmount",
            "keyword_value"=> "Enter Valid Amount"
          ],
          [
            "screenId"=> "34",
            "keyword_id"=> 346,
          ...
          [
            ...
            "keyword_value"=> "Could you kindly confirm if the service has been completed?"
          ],
          [
            "screenId"=> "34",
            "keyword_id"=> 348,
          ...
          [
            ...
            "keyword_value"=> "To proceed, please share the OTP sent to Customer."
          ],
          [
            "screenId"=> "34",
            "keyword_id"=> 350,
            "keyword_name"=> "lessWalletAmountMsg",
            "keyword_value"=> "You can’t continue because your wallet balance is below the required limit. Please add money to your wallet to keep receiving orders and notifications."
          ],
          [
            "screenId"=> "34",
            "keyword_id"=> 351,
          ...
          [
            ...
            "keyword_value"=> "Customer Not answering"
          ],
          [
            "screenId"=> "34",
            "keyword_id"=> 354,
          ...
          [
            ...
            "keyword_value"=> "Customer didn't show up on time"
          ],
          [
            "screenId"=> "34",
            "keyword_id"=> 356,
          ...
          [
            "screenId"=> "34",
            "keyword_id"=> 361,
            "keyword_name"=> "ridecancelledByRider",
            "keyword_value"=> "Ride cancelled by Customer"
          ],
          [
            "screenId"=> "34",
            "keyword_id"=> 335,
      ...
      [
        ...
        "keyword_data"=> [
          ...
          [
            ...
            "keyword_value"=> "Plate Number"
          ],
          [
            "screenId"=> "35",
            "keyword_id"=> 298,
            "keyword_name"=> "carProductionYear",
            "keyword_value"=> "Production Year"
          ]
        ]
      ],
      [
      ...
      [
        ...
        "keyword_data"=> [
          ...
          [
            "screenId"=> "40",
            "keyword_id"=> 426,
            "keyword_name"=> "parcelDetail",
            "keyword_value"=> "Parcel Detail"
          ],
          [
            "screenId"=> "40",
            "keyword_id"=> 395,
            "keyword_name"=> "choose_service",
            "keyword_value"=> "Choose a service to continue"
          ],
          [
            "screenId"=> "40",
            "keyword_id"=> 396,
            "keyword_name"=> "need_ride",
            "keyword_value"=> "Need a Ride"
          ],
          [
            "screenId"=> "40",
            "keyword_id"=> 397,
            "keyword_name"=> "delivery",
            "keyword_value"=> "Courier Delivery"
          ],
          [
            "screenId"=> "40",
            "keyword_id"=> 398,
            "keyword_name"=> "provide_delivery_details",
            "keyword_value"=> "Enter Delivery Details"
          ],
          [
            "screenId"=> "40",
            "keyword_id"=> 399,
            "keyword_name"=> "weight",
            "keyword_value"=> "Weight(Kg)"
          ],
          [
            "screenId"=> "40",
            "keyword_id"=> 400,
            "keyword_name"=> "parcel_type",
            "keyword_value"=> "Parcel Type"
          ],
          [
            "screenId"=> "40",
            "keyword_id"=> 401,
            "keyword_name"=> "sender_details",
            "keyword_value"=> "Sender Detail"
          ],
          [
            "screenId"=> "40",
            "keyword_id"=> 402,
            "keyword_name"=> "receiver_details",
            "keyword_value"=> "Receiver Detail"
          ],
          [
            "screenId"=> "40",
            "keyword_id"=> 403,
      ...
      [
        "screenID"=> "41",
        "ScreenName"=> "Choose Airport",
        "keyword_data"=> [
          [
            "screenId"=> "41",
            "keyword_id"=> 421,
            "keyword_name"=> "selectAirport",
            "keyword_value"=> "Select Airport"
          ],
          [
            "screenId"=> "41",
            "keyword_id"=> 422,
            "keyword_name"=> "searchAirport",
            "keyword_value"=> "Search Airport"
          ]
        ]
      ],
      [
        "screenID"=> "42",
        "ScreenName"=> "Choose Zone",
        "keyword_data"=> [
          [
            "screenId"=> "42",
            "keyword_id"=> 423,
            "keyword_name"=> "selectZone",
            "keyword_value"=> "Select Zone"
          ],
          [
            "screenId"=> "42",
            "keyword_id"=> 424,
            "keyword_name"=> "searchZone",
            "keyword_value"=> "Search Zone"
          ]
        ]
      ],
      [
        "screenID"=> "43",
        "ScreenName"=> "Flight Tracking Screen",
        "keyword_data"=> [
          [
            "screenId"=> "43",
            "keyword_id"=> 445,
            "keyword_name"=> "flightTacking",
            "keyword_value"=> "Flight Tracking"
          ],
          [
            "screenId"=> "43",
            "keyword_id"=> 446,
            "keyword_name"=> "overRollFlightStatus",
            "keyword_value"=> "Overall Flight Status"
          ],
          [
            "screenId"=> "43",
            "keyword_id"=> 447,
            "keyword_name"=> "flightDate",
            "keyword_value"=> "Flight Date"
          ],
          [
            "screenId"=> "43",
            "keyword_id"=> 448,
            "keyword_name"=> "DepInformation",
            "keyword_value"=> "Departure Information"
          ],
          [
            "screenId"=> "43",
            "keyword_id"=> 449,
            "keyword_name"=> "airport",
            "keyword_value"=> "Airport"
          ],
          [
            "screenId"=> "43",
            "keyword_id"=> 450,
            "keyword_name"=> "scheduledDep",
            "keyword_value"=> "Scheduled Departure"
          ],
          [
            "screenId"=> "43",
            "keyword_id"=> 451,
            "keyword_name"=> "estimatedDep",
            "keyword_value"=> "Estimated Departure"
          ],
          [
            "screenId"=> "43",
            "keyword_id"=> 452,
            "keyword_name"=> "actualDep",
            "keyword_value"=> "Actual Departure"
          ],
          [
            "screenId"=> "43",
            "keyword_id"=> 453,
            "keyword_name"=> "arriInformation",
            "keyword_value"=> "Arrival Information"
          ],
          [
            "screenId"=> "43",
            "keyword_id"=> 454,
            "keyword_name"=> "bagClaim",
            "keyword_value"=> "Baggage Claim"
          ],
          [
            "screenId"=> "43",
            "keyword_id"=> 455,
            "keyword_name"=> "scheduledArri",
            "keyword_value"=> "Scheduled Arrival"
          ],
          [
            "screenId"=> "43",
            "keyword_id"=> 456,
            "keyword_name"=> "estimatedArri",
            "keyword_value"=> "Estimated Arrival"
          ],
          [
            "screenId"=> "43",
            "keyword_id"=> 457,
            "keyword_name"=> "actualArri",
            "keyword_value"=> "Actual Arrival"
          ],
          [
            "screenId"=> "43",
            "keyword_id"=> 458,
            "keyword_name"=> "AirFlightDetails",
            "keyword_value"=> "Airline & Flight Details"
          ],
          [
            "screenId"=> "43",
            "keyword_id"=> 459,
            "keyword_name"=> "AircraftInfo",
            "keyword_value"=> "Aircraft Information"
          ],
          [
            "screenId"=> "43",
            "keyword_id"=> 460,
            "keyword_name"=> "registration",
            "keyword_value"=> "Registration"
          ],
          [
            "screenId"=> "43",
            "keyword_id"=> 461,
            "keyword_name"=> "AirCraftType",
            "keyword_value"=> "Aircraft Type"
          ],
          [
            "screenId"=> "43",
            "keyword_id"=> 462,
            "keyword_name"=> "airline",
            "keyword_value"=> "Airline"
          ]
        ]
      ],
      [
        "screenID"=> "44",
        "ScreenName"=> "Refer Screen",
        "keyword_data"=> [
          [
            "screenId"=> "44",
            "keyword_id"=> 487,
            "keyword_name"=> "lblReferralHistory",
            "keyword_value"=> "Referral History"
          ],
          [
            "screenId"=> "44",
            "keyword_id"=> 488,
            "keyword_name"=> "lblReferTitle",
            "keyword_value"=> "Refer a friend and earn up to"
          ],
          [
            "screenId"=> "44",
            "keyword_id"=> 489,
            "keyword_name"=> "lblReferSubtitle",
            "keyword_value"=> "Share this code with your friends to get rewards up to"
          ]
        ]
      ],
      [
