...
class LanguageListController extends Controller
{
    ...
    public function index(LanguageListDataTable $dataTable)
    {
        ...
        $button = $auth_user->can('languagelist-add') ? '<a href="'.route('languagelist.create').'" class="float-right btn btn-sm border-radius-10 btn-primary me-2"><i class="fa fa-plus-circle"></i> '.__('message.add_form_title',['form' => __('message.language')]).'</a>' : '';
