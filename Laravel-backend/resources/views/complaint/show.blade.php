        ...
        <div class="col-xl-8 content">
            <div class="card card-block">
                ...
                <div class="card-footer px-3 py-3">
                    {!! html()->form('POST', route('complaintcomment.store'))->attribute('data-toggle', 'validator')->id('commentForm')->attribute('button-loader', 'true')->attribute('data-ajax', 'true')->attribute('data-submit-reset', 'true')->open() !!}
                        {!! html()->hidden('id', null) !!}
                        {!! html()->hidden('complaint_id', $data->id) !!}
                        <div class="input-group mb-3">
                            {!! html()->text('comment', old('comment'))->placeholder(__('message.enter_name', ['name' => 'here...']))->class('form-control')->required() !!}
                ...
                <div class="table-responsive">
                    <table class="table align-items-center border-0">
                        <tbody>
                            ...
                            <tr>
                                <td class="t-head">Description</td>
                                <td class="t-head">{{ $data->description ?? '-' }}</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
