...
?>
{{ html()->form('DELETE', route('service.destroy', $id))->attribute('data--submit', 'service' . $id)->open()}}
...
<div class="d-flex justify-content-end align-items-center">
    ...
    @endif
    @if($auth_user->can('service show') )
        <a class="mr-2" href="{{ route('service.show',$id) }}"><i class="fas fa-eye text-secondary"></i></a>
    @endif
