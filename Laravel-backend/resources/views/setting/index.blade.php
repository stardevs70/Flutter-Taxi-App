                    ...
                    <div class="card-body">
                        <ul class="nav nav-tabs" role="tablist">
                            @if(in_array( $page,['profile_form','password_form']))
                                ...
                                @if($auth_user->user_type == 'corporate')
                                    <li class="nav-item">
                                        <a href="javascript:void(0)" data-href="{{ route('layout_page') }}?page=document_form" data-target=".paste_here" class="nav-link {{$page=='document_form'?'active':''}}"  data-toggle="tabajax" rel="tooltip"> {{ __('message.document_form') }} </a>
                                    </li>
                                @endif
                            @else
                                @hasanyrole('admin|demo_admin')
                                    ...
                                    <li class="nav-item">
                                        <a href="javascript:void(0)" data-href="{{ route('layout_page') }}?page=databasebackup-setting" data-target=".paste_here" class="nav-link {{$page=='databasebackup-setting'?'active':''}}"  data-toggle="tabajax" rel="tooltip"> {{ __('message.database_backup_settings') }}</a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="javascript:void(0)" data-href="{{ route('layout_page') }}?page=mail-template-setting" data-target=".paste_here" class="nav-link {{$page=='mail-template-setting'?'active':''}}"  data-toggle="tabajax" rel="tooltip"> {{ __('message.mail_templated') }}</a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="javascript:void(0)" data-href="{{ route('layout_page') }}?page=sms-settings" data-target=".paste_here" class="nav-link {{$page=='sms-settings'?'active':''}}"  data-toggle="tabajax" rel="tooltip"> {{ __('message.sms_setting') }}</a>
                                    </li>
                                    <li class="nav-item">
