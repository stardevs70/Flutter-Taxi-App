                        ...
                        <div class="new-user-info">
                            <div class="row">
                                <div class="form-group col-md-6">
                                    ...
                                    {!! html()->text('first_name', old('first_name'))->class('form-control')->placeholder(__('message.first_name'))->required() !!}
                                </div>
                                <div class="form-group col-md-6">
                                    {!! html()->label( __('message.last_name').' <span class="text-danger">*</span>')->class('form-control-label')->for('last_name') !!}
                                    {!! html()->text('last_name', old('last_name'))->class('form-control')->placeholder(__('message.last_name'))->required() !!}
                                </div>
                                @php
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    {{ html()->email('email', isset($id) ? optional($data)->email : old('email'))->placeholder(__('message.email'))->class('form-control')->required()->attribute($readonly, '') }}
                                </div>
                                <div class="form-group col-md-6">
                                    {{ html()->label(__('message.username').' <span class="text-danger">*</span>', 'username')->class('form-control-label') }}
                                    {{ html()->text('username', isset($id) ? optional($data)->username : old('username'))->placeholder(__('message.username'))->class('form-control')->required()->attribute($readonly, '') }}
                                </div>
                                @if(!isset($id))
                                    <div class="form-group col-md-6">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    {{ html()->text('contact_number', isset($id) ? optional($data)->contact_number : old('contact_number'))
                                            ->placeholder(__('message.contact_number'))->class('form-control')
                                            ->id('phone')->required()->attribute($readonly, '') }}
                                </div>
                            </div>
                            <hr>
