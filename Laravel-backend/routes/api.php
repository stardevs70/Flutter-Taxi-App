...
Route::group(['middleware' => ['auth:sanctum']], function () {
    ...
    Route::get('my-order-list', [ API\OrderController::class, 'MyOrderList'] );
    Route::get('order-tracking-detail', [ API\OrderController::class, 'OrderTrackingDetail'] );
    Route::get('driver-order-list', [ API\OrderController::class, 'DriverOrderList'] );
    ...
    Route::get('airport-list', [ API\AirportController::class, 'getList' ]);
    Route::get('cancelReason-list', [ App\Http\Controllers\ManageCancelledReasonController::class, 'getList' ]);
    Route::post('airport-save', [App\Http\Controllers\AirportController::class, 'store']);
    Route::post('airport-delete/{id}', [App\Http\Controllers\AirportController::class, 'destroy']);
    // Route::post('airport-update/{id}', [App\Http\Controllers\AirportController::class, 'update']);
    Route::post('airport-action', [App\Http\Controllers\AirportController::class, 'action']);

    Route::get('managezone-list', [ API\ManageZoneController::class, 'getList' ]);
    Route::post('managezone-save', [App\Http\Controllers\ManageZoneController::class, 'store']);
    Route::post('managezone-delete/{id}', [App\Http\Controllers\ManageZoneController::class, 'destroy']);
...
Route::post('snap-to-roads', [API\RideRequestController::class, 'snapToRoads']);
